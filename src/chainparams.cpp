...
{
    const char* pszTimestamp = "acbxxxxx";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1000000;//1051200
       ...
       // consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000003f94d1ad391682fe038bf5");
		...
		genesis = CreateGenesisBlock(1533096000, 3741770476, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000dae1cee718d63aaec5b6d0ae54f10c1fe3d6866f359eb62891fb1839"));
        assert(genesis.hashMerkleRoot == uint256S("0xd6f61e3429cdef24c98b95ccd344a6f510d8ce4d05735451c737a480ef891053"));
