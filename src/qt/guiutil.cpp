// Copyright (c) 2011-2016 The ACB coin bt developers
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("ACBcoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "ACBscoin:");
    }
...
{
    QString ret = QString("ACBcoin:%1").arg(info.address);
    int paramCount = 0;
