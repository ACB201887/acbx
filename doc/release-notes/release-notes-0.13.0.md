ACB coin bt version 0.13.0 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of ACB coin bt
...
Various code modernizations have been done. The ACB coin bt code base has
...
HD wallets are incompatible with older versions of ACB coin bt.
...
proposed parameters, a future release of ACB coin bt is expected that
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use ACB/kB (MarcoFalke)
