...
*Setup instructions for a Gitian build of ACB coin bt using a Debian VM or physical system.*
...
- [Building ACB coin bt](#building-bitcoin-core)
...
To build ACB coin bt (for Linux, OS X and Windows) just follow the steps under 'perform
